...
func InferNonstream(url string) bool {
	return strings.Contains(strings.ToLower(url), "nostream")
}

func NewFullClientRequest(audio AudioMeta, nonstream bool) []byte {
